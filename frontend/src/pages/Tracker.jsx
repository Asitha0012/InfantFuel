  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-10 mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Section title="Growth Tracking" onClick={() => console.log('Growth tracking clicked')}>
        ...
        <Section title="Nutrition Tracking" onClick={() => console.log('Nutrition tracking clicked')}>
          <div className="grid grid-cols-3 gap-4">
        ...
        {/* Health Section */}
        <Section title="Health" onClick={() => console.log('Health clicked')}>
        ...
        <Section title="Recent Activities" onClick={() => console.log('Recent activities clicked')}>
